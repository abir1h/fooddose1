...
class add_shipping extends StatefulWidget {
  final double? lat;
  final double? lon;
  const add_shipping({this.lat, this.lon});

  @override
  State<add_shipping> createState() => _add_shippingState();
}

class _add_shippingState extends State<add_shipping> {
          ...
          children: [
            ...
            InkWell(
              onTap: (){
                ...
                Get.to(()=>AppBottomNavigation(index: 1,));
                },
              child: Container(
